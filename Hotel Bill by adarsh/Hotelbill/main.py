...
def load_menu():
    ...
    menu_file_list = os.listdir("F:\Hotel Bill Project\Hotelbill\Menu")
    for file in menu_file_list:
        f = open("F:\Hotel Bill Project\Hotelbill\Menu/New Text Document.txt", "r")
        category = ""
        while True:
            line = f.readline()
            if (line == ""):
...
def show_button_operation():
    ...
    if category not in menu_category:
        ...
        menu_tabel.delete(*menu_tabel.get_children())
        f = open("F:\Hotel Bill Project\Hotelbill\Menu" + menu_category_dict[category], "r")
        while True:
            line = f.readline()
            if (line == ""):
                break
...
def bill_button_operation():
    ...
    if ans == "yes":
        ...
        file = open("F:\\Hotel Bill Project\Hotelbill\Bill\Records{customer_name + customer_contact}.txt", "w")
        file.write(st)
        file.close()
